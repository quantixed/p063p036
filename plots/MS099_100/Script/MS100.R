...
nameCond <- c("BeforeLatB1", "AfterLatB1", "AfterLatB2", "AfterLatB3", "AfterLatB4", "BeforeLatB2", "BeforeLatB3")

#Indicate the path of the folders contaning your data in the same order of the name provided before. 
dirCond1 <- "Data/Data LatB/BeforeLatB_016_crop1/" #put the name of your folders here
dirCond2 <- "Data/Data LatB/AfterLatB_022_Crop1/" #put the name of your folders here
dirCond3 <- "Data/Data LatB/AfterLatB_022_Crop2/" #put the name of your folders here
dirCond4 <- "Data/Data LatB/AfterLatB_022_Crop3/" #put the name of your folders here
dirCond5 <- "Data/Data LatB/AfterLatB_026_Crop1/" #put the name of your folders here
dirCond6 <- "Data/Data LatB/BeforeLatB_016_crop3/" #put the name of your folders here
dirCond7 <- "Data/Data LatB/BeforeLatB_001_crop1/" #put the name of your folders here
...
# save last plot
ggsave("MS100_Ranalysis_plotFraction.pdf", path = "Output/Plots", dpi = 300, width = 33, height = 50  , units = "mm" ,  bg = NULL)

#Print plot
plotFreqClass

# save last plot
ggsave("MS100_Ranalysis_FreqClass.pdf", path = "Output/Plots", dpi = 300, width = 40, height = 20  , units = "cm" ,  bg = NULL)
...
# save last plot
ggsave("MS100_Ranalysis_parameters_directed.pdf", path = "Output/Plots", dpi = 300, width = 40, height = 20  , units = "cm" ,  bg = NULL)
...
# save last plot
ggsave("MS100_Ranalysis_Final.pdf", path = "Output/Plots", dpi = 300, width = 40, height = 20  , units = "cm" ,  bg = NULL)

# save important df 
write.csv(dfCond, paste("Output/Data/", "MS100_AllConditions.csv"), row.names = FALSE)
write.csv(dfCondnoNA, paste("Output/Data/", "MS100_AllConditions_noNA.csv"), row.names = FALSE)
write.csv(OccurenceClassCond, paste("Output/Data/", "MS100_OccurenceClassCond.csv"), row.names = FALSE)
write.csv(FractionAboveThreeshold, paste("Output/Data/", "MS100_FractionAboveThreeshold.csv"), row.names = FALSE)
write.csv(Fractioncount, paste("Output/Data/", "MS100_FractionAboveThreeshold_replicates.csv"), row.names = FALSE)
